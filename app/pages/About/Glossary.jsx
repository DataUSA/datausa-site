    ...
    return (
      <div id="Glossary">
        ...
        <div className="content">
          ...
          <ul>
            <li><span className="bp3-icon bp3-icon-dot"></span>Nests within states or equivalent entities</li>
            <li><span className="bp3-icon bp3-icon-dot"></span>Contains at least 100,000 people</li>
            <li><span className="bp3-icon bp3-icon-dot"></span>Covers the entirety of the United States, Puerto Rico, Guam, and the U.S. Virgin Islands</li>
            <li><span className="bp3-icon bp3-icon-dot"></span>Is built on census tracts and counties</li>
            <li><span className="bp3-icon bp3-icon-dot"></span>Should be geographically contiguous</li>
          </ul>
          <p>
