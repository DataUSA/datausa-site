  ...
  render() {
    ...
    return (
      <div id="Background">
        ...
        <p>
          Deloitte refers to one or more of Deloitte Touche Tohmatsu Limited, a UK private company limited by guarantee (“DTTL”), its network of member firms, and their related entities. DTTL and each of its member firms are legally separate and independent entities. DTTL (also referred to as “Deloitte Global”) does not provide services to clients. Please see <a href="https://www.deloitte.com/about" target="_blank" rel="noopener noreferrer">www.deloitte.com/about</a> for a detailed description of DTTL and its member firms. Please see <a href="https://www.deloitte.com/us/about" target="_blank" rel="noopener noreferrer">www.deloitte.com/us/about</a> for a detailed description of the legal structure of Deloitte LLP and its subsidiaries. Certain services may not be available to attest clients under the rules and regulations of public accounting. For more information about how Deloitte handles personal data, please see Deloitte's <a href="https://www.deloitte.com/us/en/legal/privacy.html" target="_blank" rel="noopener noreferrer">privacy notice</a>.
        </p>
