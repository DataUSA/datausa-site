export const usage = {
  "agency-for-healthcare-research-and-quality": [
    "Patient access and care data is featured in the Health section of the geography reports."
  ],
  "bureau-of-economic-analysis": [
    "The BEA I/O tables are used on the industry reports, showing the input and output industries for the specified industry report."
  ],
  ...
  "centers-for-medicare-and-medicaid-services-cms": [
    "Medicare and medicaid data is featured in the Health section of the geography reports."
  ],
  "center-on-budget-and-policy-priorities": [
    "Rental assistance data is featured in the Health section of the geography reports."
  ],
  "commonwealth-fund": [
  ...
  "mit-election-lab": [
    "Presidential, Senate, and Representative voting results are featured in the Civics section of the geography reports."
  ],
  "onet-online": [
...
export const caveats = {
  ...
  "mit-election-lab": [
    ...
    "The land boundaries for a portion of the geographical reports featured in Data USA do not line up perfectly with congressional districts. In this case, when displaying representatives for the given location, we include any congressional district whose geographical boundaries overlap the given location's boundaries."
  ],
  "onet-online": [
